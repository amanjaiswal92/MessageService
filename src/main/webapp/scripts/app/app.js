...
angular.module('naradApp', ['LocalStorageModule', 
               'ui.bootstrap', // for modal dialogs
    'ngResource', 'ui.router', 'ngCookies', 'ngAria', 'ngCacheBuster', 'ngFileUpload', 'infinite-scroll'])

    .run(function($rootScope, $location, $window, $http, $state, AuthServerProvider, Auth, Principal, ENV, VERSION) {
		  var keycloakAuth = new Keycloak('keycloak.json');
		  keycloakAuth.init({
		    responseMode: 'query'
		  }).success(function() {
		    AuthServerProvider.authorise(keycloakAuth);
		  }).error(function() {
