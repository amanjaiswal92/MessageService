...
import com.ail.narad.web.filter.CachingHttpHeadersFilter;
import com.ail.narad.web.filter.StaticResourcesProductionFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
	...
	// Hazelcast instance is injected to force its initialization before the
	// Servlet filter uses it.
	@Inject
	...
	private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
		...
		disps = EnumSet.of(DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ASYNC,
		...
		parameters.put("instance-name", "narad");
		...
		// on a node, entries for this session on all other nodes are
		// invalidated.
