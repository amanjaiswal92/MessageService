(function(window, undefined) {
  var Keycloak = function(config) {
    ...
    kc.createLoginUrl = function(options) {
      ...
      sessionStorage.oauthState = JSON.stringify({
        state: state,
      ...
      var url = getRealmUrl() + '/protocol/openid-connect/' + action + '?client_id=' + encodeURIComponent(kc.clientId) + '&redirect_uri=' + encodeURIComponent(redirectUri) + '&state=' + encodeURIComponent(state) + '&response_type=code';
    ...
    kc.createLogoutUrl = function(options) {
      var url = getRealmUrl() + '/protocol/openid-connect/logout' + '?redirect_uri=' + encodeURIComponent(adapter.redirectUri(options));
